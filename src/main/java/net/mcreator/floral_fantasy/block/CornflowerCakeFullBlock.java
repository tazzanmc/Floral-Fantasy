...
import net.mcreator.floral_fantasy.procedures.CornflowerCakeFullEatProcedure;
...
public class CornflowerCakeFullBlock extends FloralFantasyModElements.ModElement {
	@ObjectHolder("floral_fantasy:cornflower_cake_full")
	public static final Block block = null;
	public CornflowerCakeFullBlock(FloralFantasyModElements instance) {
		super(instance, 59);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cornflower_cake_full");
		}
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				CornflowerCakeFullEatProcedure.executeProcedure($_dependencies);
			}
