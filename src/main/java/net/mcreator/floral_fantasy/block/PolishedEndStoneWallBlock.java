...
public class PolishedEndStoneWallBlock extends FloralFantasyModElements.ModElement {
	@ObjectHolder("floral_fantasy:polished_end_stone_wall")
	public static final Block block = null;
	public PolishedEndStoneWallBlock(FloralFantasyModElements instance) {
		super(instance, 144);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("polished_end_stone_wall");
		}
