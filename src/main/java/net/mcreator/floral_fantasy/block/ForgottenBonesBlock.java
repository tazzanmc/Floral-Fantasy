...
import net.mcreator.floral_fantasy.procedures.ForgottenBonesOnBlockRightClickedProcedure;
...
public class ForgottenBonesBlock extends FloralFantasyModElements.ModElement {
	@ObjectHolder("floral_fantasy:forgotten_bones")
	public static final Block block = null;

	public ForgottenBonesBlock(FloralFantasyModElements instance) {
		super(instance, 329);
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.BONE).hardnessAndResistance(2f, 10f).setLightLevel(s -> 0).harvestLevel(0)
					.harvestTool(ToolType.PICKAXE).setRequiresTool().notSolid().setOpaque((bs, br, bp) -> false));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.NORTH).with(WATERLOGGED, false));
			setRegistryName("forgotten_bones");
		}
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			ForgottenBonesOnBlockRightClickedProcedure.executeProcedure(Stream
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("floral_fantasy:forgotten_bones_match"),
			...
			event.getRegistry().register(feature.setRegistryName("forgotten_bones"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("floral_fantasy:forgotten_bones"), configuredFeature);
		}
	}
