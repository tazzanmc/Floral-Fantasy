...
public class SourBerryBushStage2Block extends FloralFantasyModElements.ModElement {
	@ObjectHolder("floral_fantasy:sour_berry_bush_stage_2")
	public static final Block block = null;
	@ObjectHolder("floral_fantasy:sour_berry_bush_stage_2")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public SourBerryBushStage2Block(FloralFantasyModElements instance) {
		super(instance, 259);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry()
					.register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("sour_berry_bush_stage_2"));
		}
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sour_berry_bush_stage_2");
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("sour_berry_bush_stage_2");
		}
