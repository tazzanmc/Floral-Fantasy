...
public class SourBerryBushStage1Block extends FloralFantasyModElements.ModElement {
	@ObjectHolder("floral_fantasy:sour_berry_bush_stage_1")
	public static final Block block = null;
	@ObjectHolder("floral_fantasy:sour_berry_bush_stage_1")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public SourBerryBushStage1Block(FloralFantasyModElements instance) {
		super(instance, 258);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry()
					.register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("sour_berry_bush_stage_1"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sour_berry_bush_stage_1");
		}
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			return VoxelShapes.or(makeCuboidShape(3, 0, 3, 13, 8, 13)).withOffset(offset.x, offset.y, offset.z);
		}
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(UnripeSourBerriesItem.block);
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("sour_berry_bush_stage_1");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Sour Berry Bush");
		}
