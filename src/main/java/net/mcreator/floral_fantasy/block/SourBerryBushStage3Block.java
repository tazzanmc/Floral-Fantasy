...
public class SourBerryBushStage3Block extends FloralFantasyModElements.ModElement {
	@ObjectHolder("floral_fantasy:sour_berry_bush_stage_3")
	public static final Block block = null;
	@ObjectHolder("floral_fantasy:sour_berry_bush_stage_3")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public SourBerryBushStage3Block(FloralFantasyModElements instance) {
		super(instance, 260);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry()
					.register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("sour_berry_bush_stage_3"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sour_berry_bush_stage_3");
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("sour_berry_bush_stage_3");
		}
