...
import net.mcreator.floral_fantasy.procedures.RichChocolateCakeFullEatProcedure;
...
public class RichChocolateCakeFullBlock extends FloralFantasyModElements.ModElement {
	@ObjectHolder("floral_fantasy:rich_chocolate_cake_full")
	public static final Block block = null;
	public RichChocolateCakeFullBlock(FloralFantasyModElements instance) {
		super(instance, 237);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("rich_chocolate_cake_full");
		}
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				RichChocolateCakeFullEatProcedure.executeProcedure($_dependencies);
			}
