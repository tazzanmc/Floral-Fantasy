...
public class PyreticOasis2Structure {
	...
	private static class FeatureRegisterHandler {
		...
		public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 15000) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("floral_fantasy", "pyretic_oasis_2"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("pyretic_oasis_2"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("floral_fantasy:pyretic_oasis_2"), configuredFeature);
		}
	}
