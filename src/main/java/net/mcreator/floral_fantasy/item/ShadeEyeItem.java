...
public class ShadeEyeItem extends FloralFantasyModElements.ModElement {
	@ObjectHolder("floral_fantasy:shade_eye")
	public static final Item block = null;
	public ShadeEyeItem(FloralFantasyModElements instance) {
		super(instance, 7);
	}
