...
import net.mcreator.floral_fantasy.block.PottedWeepingBellBlock;
import net.mcreator.floral_fantasy.FloralFantasyMod;

import java.util.Map;
import java.util.HashMap;

public class WeepingBellPottingProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				FloralFantasyMod.LOGGER.warn("Failed to load dependency x for procedure WeepingBellPotting!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				FloralFantasyMod.LOGGER.warn("Failed to load dependency y for procedure WeepingBellPotting!");
			return;
		}
		...
		if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == Blocks.FLOWER_POT) {
			if (((entity instanceof LivingEntity) ? ((LivingEntity) entity).getHeldItemMainhand() : ItemStack.EMPTY)
				...
				if (entity instanceof PlayerEntity) {
					ItemStack _stktoremove = new ItemStack(WeepingBellBlock.block);
