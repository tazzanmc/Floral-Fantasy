 ...
 *
 *    Keep the FloralFantasyModElements object in this class and all calls to this object
...
@Mod("floral_fantasy")
public class FloralFantasyMod {
	public static final Logger LOGGER = LogManager.getLogger(FloralFantasyMod.class);
	...
	public FloralFantasyMod() {
		...
		MinecraftForge.EVENT_BUS.register(new FloralFantasyModFMLBusEvents(this));
	}
