...
import net.mcreator.floral_fantasy.procedures.BabyWaderOnEntityTickUpdateProcedure;
...
public class BabyWaderEntity extends FloralFantasyModElements.ModElement {
	...
	public static class CustomEntity extends CreatureEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(3, new TemptGoal(this, 0.8, Ingredient.fromItems(Blocks.CRIMSON_FUNGUS.asItem()), false));
