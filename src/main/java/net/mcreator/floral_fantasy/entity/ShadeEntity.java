...
import net.mcreator.floral_fantasy.entity.renderer.ShadeRenderer;
...
public class ShadeEntity extends FloralFantasyModElements.ModElement {
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(entity, 3, 2, 4));
	}
	...
	public static class CustomEntity extends MonsterEntity implements IRangedAttackMob {
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(6, new NearestAttackableTargetGoal(this, BlazeEntity.class, false, false));
		...
		public void attackEntityWithRangedAttack(LivingEntity target, float flval) {
			ShadeShotItem.shoot(this, target);
		}
